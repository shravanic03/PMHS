...
# Assuming you have loaded your NLP model and translation functions
nlp = spacy.load("en_core_web_sm")  # Load your NLP model here

# Dummy translation functions
def translate_text_swa_eng(text):
    return "Translated to English"

def translate_text_eng_swa(text):
    return "Translated to Swahili"

def chatbot_response(text):
    return "Chatbot response to the text"

# Streamlit app starts here
st.title("Chatbot with Language Detection")

# Input from the user
userText = st.text_input("You: ", "Type your message here...")

if userText:
    st.write("get_bot_response:- " + userText)
    ...
    if detected_language == "en":
        ...
        st.write("en_sw get_bot_response:-", bot_response_translate)
    elif detected_language == 'sw':
        bot_response_translate = translate_text_swa_eng(userText)
        st.write("sw_en get_bot_response:-", bot_response_translate)
    ...
    st.write("Bot: ", chatbot_response_text)
